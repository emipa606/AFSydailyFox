...
public static class JobGiver_Manhunter_TryGiveJob
{
        ...
        else
        {
            ...
            else
            {
                var thing = (Thing)ARA_AttackTargetFinder.BestAttackTarget(pawn,
                                ...
                                x => x is Pawn or Building) ??
                            (Thing)ARA_AttackTargetFinder.BestAttackTarget(pawn, TargetScanFlags.NeedThreat,
                                x => x is Pawn or Building);
                ...
                if (thing == null)
                {
                    thing2 = (Thing)ARA_AttackTargetFinder.BestShootTargetFromCurrentPosition(pawn,
                        x => x is Pawn or Building, verb.verbProps.range, verb.verbProps.minRange,
